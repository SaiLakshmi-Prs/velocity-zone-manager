  ...
  useEffect(() => {
    ...
    zones.forEach(zone => {
      ...
      if (geom instanceof Polygon) {
        const paths = generateMowingPaths(geom, 25);
        ...
        {isDrawingMode && (
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="bg-slate-900 border border-slate-800 hover:bg-slate-800 text-slate-355 hover:text-white px-3 py-1.5 rounded-xl text-xs font-semibold shadow-lg cursor-pointer transition-colors"
            >
              Cancel Drawing
            </button>
          </div>
